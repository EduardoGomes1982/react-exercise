    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Start />}>
          ...
          <Route path="/home" element={<Main elementCard={<StartCard />} primaryButtonText="Ver Promoção" buttonLink="/offer" />} />
          <Route path="/offer" element={<Main elementCard={<OfferCard />} primaryButtonText="Quero Participar" buttonLink="/registration" />} />
          <Route path="/registration" element={<Main elementCard={<RegistrationCard />} primaryButtonText="Ver Promoção" buttonLink="/offer" />} />
        </Route>
      </Routes>
    </BrowserRouter>
  );
